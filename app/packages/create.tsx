    ...
    <View className="flex-1 bg-gray-50 dark:bg-gray-950">
      ...
      <ScrollView className="flex-1 px-4 pt-3">
        <View className="rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-6" style={{ shadowColor: '#000', shadowOpacity: 0.08, shadowRadius: 12, elevation: 6 }}>
          <Text className="mb-4 text-2xl font-extrabold text-gray-900 dark:text-gray-100">สร้างแพ็คเกจ</Text>

          <Field label="ชื่อแพ็คเกจ">
            <TextInput value={name} onChangeText={(t) => setValue('name', t)} placeholder="Advance" placeholderTextColor="#9ca3af" className="border-b border-gray-200 dark:border-gray-700 pb-2 text-base text-gray-900 dark:text-gray-100" />
          </Field>
          <Field label="ราคา">
